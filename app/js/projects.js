...
function showProjModal(p) {
  ...
  if (b) b.innerHTML = `
    ...
    <div style="display:flex;flex-wrap:wrap;gap:10px;font-size:13px;">
      ${p.status     ? `<div><strong>Durum:</strong> ${statusMap[p.status]?.label || esc(p.status)}</div>` : ''}
  ...
  if (c) c.href = `mailto:cybersense@sakarya.edu.tr?subject=${encodeURIComponent(p.title + ' - Başvuru Hk.')}`;
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="proj-card fade-up visible">
            ...
            <div style="display:flex;gap:8px;margin-top:14px;">
              ...
              <a href="mailto:cybersense@sakarya.edu.tr?subject=${encodeURIComponent(p.title + ' - Başvuru Hk.')}"
