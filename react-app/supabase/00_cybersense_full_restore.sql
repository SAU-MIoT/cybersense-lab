...
BEGIN
  CASE p_table
    WHEN 'announcements' THEN
      ...
      pk_col := 'id';
      pk_type := 'uuid';
      order_by := 'COALESCE(publish_date, created_at) DESC, created_at DESC';
      insert_cols := ARRAY['title','content','publish_date','is_published'];
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.admin_users'::regclass AND conname = 'admin_users_pkey') THEN ALTER TABLE ONLY public."admin_users" ADD CONSTRAINT "admin_users_pkey" PRIMARY KEY (user_id); END IF; END $constraint$;

DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.admin_users'::regclass AND conname = 'admin_users_user_id_fkey') THEN ALTER TABLE ONLY public."admin_users" ADD CONSTRAINT "admin_users_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE; END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.announcements'::regclass AND conname = 'announcements_pkey') THEN ALTER TABLE ONLY public."announcements" ADD CONSTRAINT "announcements_pkey" PRIMARY KEY (id); END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.arastirma_alanlari'::regclass AND conname = 'arastirma_alanlari_pkey') THEN ALTER TABLE ONLY public."arastirma_alanlari" ADD CONSTRAINT "arastirma_alanlari_pkey" PRIMARY KEY (id); END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.content_images'::regclass AND conname = 'content_images_pkey') THEN ALTER TABLE ONLY public."content_images" ADD CONSTRAINT "content_images_pkey" PRIMARY KEY (id); END IF; END $constraint$;

DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.content_images'::regclass AND conname = 'content_images_entity_type_check') THEN ALTER TABLE ONLY public."content_images" ADD CONSTRAINT "content_images_entity_type_check" CHECK (entity_type = ANY (ARRAY['announcements'::text, 'projects'::text, 'etkinlikler'::text])); END IF; END $constraint$;

DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.content_images'::regclass AND conname = 'content_images_image_url_check') THEN ALTER TABLE ONLY public."content_images" ADD CONSTRAINT "content_images_image_url_check" CHECK (length(TRIM(BOTH FROM image_url)) > 0); END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.ekip'::regclass AND conname = 'ekip_pkey') THEN ALTER TABLE ONLY public."ekip" ADD CONSTRAINT "ekip_pkey" PRIMARY KEY (id); END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.etkinlikler'::regclass AND conname = 'etkinlikler_pkey') THEN ALTER TABLE ONLY public."etkinlikler" ADD CONSTRAINT "etkinlikler_pkey" PRIMARY KEY (id); END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.oduller'::regclass AND conname = 'oduller_pkey') THEN ALTER TABLE ONLY public."oduller" ADD CONSTRAINT "oduller_pkey" PRIMARY KEY (id); END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.ortaklar'::regclass AND conname = 'ortaklar_pkey') THEN ALTER TABLE ONLY public."ortaklar" ADD CONSTRAINT "ortaklar_pkey" PRIMARY KEY (id); END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.projects'::regclass AND conname = 'projects_pkey') THEN ALTER TABLE ONLY public."projects" ADD CONSTRAINT "projects_pkey" PRIMARY KEY (id); END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.site_ayarlari'::regclass AND conname = 'site_ayarlari_pkey') THEN ALTER TABLE ONLY public."site_ayarlari" ADD CONSTRAINT "site_ayarlari_pkey" PRIMARY KEY (key); END IF; END $constraint$;
...
DO $constraint$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_constraint WHERE conrelid = 'public.yayinlar'::regclass AND conname = 'yayinlar_pkey') THEN ALTER TABLE ONLY public."yayinlar" ADD CONSTRAINT "yayinlar_pkey" PRIMARY KEY (id); END IF; END $constraint$;
